        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl">
            <button
              ...
              className="bg-secondary text-primary px-6 py-3 rounded-lg font-semibold hover:bg-opacity-80 transition-all duration-300 transform hover:scale-105"
            >
              Live Demo
            </button>
          </div>
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        These projects highlight my frontend development skills through real-world examples. Each one includes a brief description along with links to the live demo and code repository, showcasing my ability to create user-friendly interfaces, solve problems, and work with modern web technologies."
        </p>
      </div>
